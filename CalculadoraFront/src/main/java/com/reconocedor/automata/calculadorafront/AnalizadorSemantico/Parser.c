...
{
      12,     0,    -1,    13,    -1,    14,    -1,    14,    13,    -1,
       3,    -1,    10,    -1,    14,     6,    14,    -1,    14,     7,
      14,    -1,    14,     8,    14,    -1,    14,     9,    -1,    14,
       5,    -1,    14,     4,    -1
};
...
{
  "$end", "error", "$undefined", "NUMERAL", "MASMENOS", "IGUAL", "SUMA",
  "RESTA", "MULT", "MP", "MR", "$accept", "program", "exprSequence",
  "expression", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 47 "AnalizadorSintactico.y"
    {
                operacion((yyvsp[(1) - (1)].nombre),2);
                (yyval.nombre) = (yyvsp[(1) - (1)].nombre);
                numDigito++;
              ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 54 "AnalizadorSintactico.y"
    {
                operacion((yyvsp[(3) - (3)].nombre),3);
                (yyval.nombre) = (yyvsp[(3) - (3)].nombre);
                numDigito++;
              ;}
    break;
...
#line 73 "AnalizadorSintactico.y"
    {
                operacion((yyvsp[(1) - (2)].nombre),6);
                (yyval.nombre) = (yyvsp[(1) - (2)].nombre);
                numDigito++;
              ;}
    break;
